 ...
 */
export async function readPptx(file: File | ArrayBuffer, _options?: PptxOptions): Promise<unknown> {
 ...
 */
export async function writePptx(presentation: unknown, _options?: PptxOptions): Promise<Blob> {
